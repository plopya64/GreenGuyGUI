...
local function Notify(text,title,duration)
	...
	-- Green Theme
	frame.BackgroundColor3 = Color3.fromRGB(22,85,22)
	...
	-- Green White
	titleLabel.TextColor3 = Color3.fromRGB(220,255,220)
	...
	task.delay(duration,function()
		...
		local titleFade = TweenService:Create(titleLabel,TweenInfo.new(0.3),{
			TextTransparency = 1
		})

		local bodyFade = TweenService:Create(bodyLabel,TweenInfo.new(0.3),{
			TextTransparency = 1
		})
...
Notify("Welcome To GreenGuyGui", "Have fun!", 3)
...
-- Green Theme
mainFrame.BackgroundColor3 = Color3.fromRGB(28, 38, 28)
...
-- Green Theme
tooltip.BackgroundColor3 = Color3.fromRGB(35, 70, 35)
...
-- Green Header
titleBar.BackgroundColor3 = Color3.fromRGB(0,170,0)
...
titleLabel.BackgroundTransparency = 1
titleLabel.Text = "GreenGuyGui V1"
titleLabel.Font = Enum.Font.SourceSansBold
titleLabel.TextSize = 18
titleLabel.TextColor3 = Color3.fromRGB(220,255,220)
titleLabel.TextXAlignment = Enum.TextXAlignment.Left
...
-- Green Button
minBtn.BackgroundColor3 = Color3.fromRGB(40,140,40)
...
-- Green Navigation
leftCat.BackgroundColor3 = Color3.fromRGB(35,130,35)
...
rightCat.Text = ">"
rightCat.BackgroundColor3 = Color3.fromRGB(35,130,35)
...
gridFrame.Size = UDim2.new(
	1,
	-2 * GRID_PADDING,
	0,
	GUI_HEIGHT - TITLE_HEIGHT - NAV_HEIGHT - FOOTER_HEIGHT - 2 * GRID_PADDING
)
gridFrame.Position = UDim2.new(
	0,
	GRID_PADDING,
	0,
	TITLE_HEIGHT + NAV_HEIGHT + GRID_PADDING
)
...
-- Green Scroll Bar
gridFrame.ScrollBarImageColor3 = Color3.fromRGB(0, 170, 0)
...
gridLayout.CellSize = UDim2.new(
	0,
	(GUI_WIDTH - 2 * GRID_PADDING - (GRID_COLUMNS - 1) * GRID_PADDING) / GRID_COLUMNS,
	0,
	40
)
...
-- Green Close Button
closeBtn.BackgroundColor3 = Color3.fromRGB(30,150,30)
...
logo.Image                = "rbxassetid://134275282726153"
...
FunctionManager:register("JumpPowerSlider", function()
	...
	closeBtn.TextSize           = 14
	closeBtn.Text               = "Close"
	closeBtn.BackgroundColor3   = Color3.fromRGB(120, 255, 120)
	closeBtn.TextColor3         = Color3.new(1,1,1)
	closeBtn.ZIndex             = 52
	closeBtn.Parent             = panel
	closeBtn.MouseButton1Click:Connect(function()
